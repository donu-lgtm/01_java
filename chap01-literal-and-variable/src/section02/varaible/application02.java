...
public class application02 {
    public static void main(String[] args) {
         ...
         * 하나의 값으로 취급하겠다는 약속이다.
         * 이러한 자료형은 기본자료형 참조자료형으로 나우어진다
         * 그중 기본자료형 8가지를 먼저 확인한다.*/
        System.out.println("________________________");
        //목차 1-1 숫자를 취급하는 자료형
        // 1byte는 8개의 bit 가 모여진 데이터 단위이다.
        // 자바 데이터의 기본 단위는 1byte
        ...
        System.out.println("________________변수초기화______________");


        /*목차2 변수에 값을 대입하기
        * 위에서 한 변수 선언은 메모리에 값을 저장하기 위해
        * 공간만 생성해 둔 상태이다.
        * 그 공간에 대입 연산자를 이욯하여 자료형에 저장하기로
        * 한형태의 값을 저장할 수 있다
        ...
        * ㅎㅕㅇ태로 사용할 수 있는 자료형을 대표자료형 이라고 하며
